...
%tim h(x) voi Theta1 va Theta2 ban dau
X = [ones(m,1), X]; 
a1=X %5000*401
z2=sigmoid(a1*Theta1') %5000*25
a2=[ones(size(z2,1),1), z2] %5000*26
z3=a2*Theta2' %5000*10
h=sigmoid(z3)

%chuyen y thanh dang vector 0/1 de ap dung thuat toan
...
%add regulization to cost function
J = J + (lambda/(2*m)) * (sum(sum(Theta1(:, 2:end).^2)) + sum(sum(Theta2(:, 2:end).^2)))

%add regulization to gradient
